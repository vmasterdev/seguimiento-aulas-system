...
exports.normalizeProgramKey = normalizeProgramKey;
exports.sanitizeId = sanitizeId;
exports.normalizeTeacherId = normalizeTeacherId;
...
function normalizeMoment(raw) {
    ...
    if (!value)
        return "1";
    if (["RY1"].includes(value))
        return "MD1";
    if (["RY2"].includes(value))
        return "MD2";
    if (["RYC", "SEMESTRAL"].includes(value))
        return "1";
    if (["INM"].includes(value))
        return "INTER";
