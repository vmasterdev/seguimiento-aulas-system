...
const course_schedule_1 = require("./course-schedule");
...
function scoreEjecucion(checklist, options) {
    ...
    const schedule = (0, course_schedule_1.buildCourseScheduleInfo)({
    ...
    const ingresosScore = typeof ingresosRaw === "number"
