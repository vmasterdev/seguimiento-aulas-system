...
exports.OutboxSendSchema = exports.OutboxExportSchema = exports.OutboxGenerateSchema = exports.EvaluationRecalculateSchema = exports.EvaluationScoreSchema = exports.SamplingGenerateSchema = exports.QueueEnqueueSchema = exports.OutboxStatusSchema = exports.ExecutionPolicySchema = exports.EvaluationPhaseSchema = exports.ErrorCodeSchema = exports.MoodleStatusSchema = exports.TemplateSchema = exports.MomentSchema = void 0;
...
exports.OutboxSendSchema = zod_1.z.object({
    ...
    moment: exports.MomentSchema.optional(),
    moments: zod_1.z.array(exports.MomentSchema).min(1).max(6).optional(),
    audience: zod_1.z.string().trim().optional(),
