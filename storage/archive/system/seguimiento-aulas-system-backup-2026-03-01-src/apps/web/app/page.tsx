...
export default async function Page() {
  ...
  return (
    <main>
      ...
      <section className="section">
        <ReviewPanel apiBase={API_BASE} initialMoodleUrlTemplate={MOODLE_URL_TEMPLATE} />
      ...
      <section className="section">
        ...
        <article className="panel">
          <h2>Notas</h2>
          <div className="actions">
            - Tipo de aula se toma del cargue visual/importado y ahora puede ajustarse manualmente desde la revision.
            <br />- El muestreo usa la llave: Docente + Modalidad + Programa + Momento + Tipo de aula.
            <br />- Al guardar una seleccion, la nota se replica automaticamente al resto del grupo.
          </div>
        </article>
      </section>
    </main>
